...
#define DEBUG_CONSOLE_TX_Pin GPIO_PIN_10
#define DEBUG_CONSOLE_TX_GPIO_Port GPIOB
#define DEBUG_CONSOLE_RX_Pin GPIO_PIN_11
#define DEBUG_CONSOLE_RX_GPIO_Port GPIOB
